...
public class FileController {
    ...
    /**
     * ************************************************ URL:
     * /rest/controller/upload upload(): receives files
     * 
     * @param request
	...
	while (iterator.hasNext()) {
	    ...
	    fileMeta.setThumbnailPath(FilePathConstants.FILE_RESIZE_PATH + multipartFile.getOriginalFilename());
    ...
    /**
     * ************************************************ URL:
     * /rest/controller/get/{value} get(): get file as an attachment
     * 
     * @param response
	...
	try {
	    ...
	    response.setHeader("Content-disposition", "attachment; filename=\"" + getFile.getThumbnailPath() + "\"");
